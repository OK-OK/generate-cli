 ...
 * @LastEditTime: 2022-07-12 09:58:50
...
const getOutputContent = {
    vue(packages, mainContent, outputPath) {
        ...
        packages.forEach(package => {
            const o = packageList.vue.concat(packageList.public).find(it => it.name === package)
            if (o.vueUse) {
...
module.exports = async (type, packages, outputPath) => {
    ...
    const outputContent = getOutputContent[type](packages, mainContent, outputPath);
